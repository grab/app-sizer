...
* InfluxDB database - suitable for CI tracking and enabling the creation of customized dashboards. 
* JSON data for compatibility with other platforms.

We are actively working on expanding our database support to accommodate a wider range of analytics capabilities in the near future.
...
For plugin configuration options, see [Plugin Configuration](plugin_extension.md).
...
For command line configuration options, see [Commandline Configuration](cli_configuration.md).
